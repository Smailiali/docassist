    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#2E75B6] mb-2">DocAssist</h1>
          <p className="text-gray-500 text-sm">Chat with your documents using AI</p>
        </div>

        {/* Card */}
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col items-center gap-6">
          <p className="text-gray-600 text-sm text-center">
            Sign in to upload PDFs and get instant answers, summaries, and insights.
          </p>

          {/* Google sign-in button */}
          <a
            href="/api/auth/google"
            className="flex items-center gap-3 w-full justify-center px-4 py-2.5 bg-white border border-gray-300 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-150 focus:outline-none focus:ring-2 focus:ring-[#2E75B6]/30"
          >
